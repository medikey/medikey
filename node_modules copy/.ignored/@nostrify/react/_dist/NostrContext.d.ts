...
/** The shape of the Nostr context provided by NostrProvider. */ export interface NostrContextType {
  /** The Nostr relay pool for querying and publishing events */ nostr: NPool;
}
/**
