import {
  UnheadContext
} from "./chunk-JULMFRHM.js";
import {
  FlatMetaPlugin,
  SafeInputPlugin
} from "./chunk-CZ5YOPZG.js";
import {
  HasElementTags,
  ScriptNetworkEvents,
  TagsWithInnerContent,
  ValidHeadTags
} from "./chunk-FFYV46VF.js";
import {
  require_react
...
// node_modules/.pnpm/@unhead+react@2.0.17_react@18.3.1/node_modules/@unhead/react/dist/index.mjs
var import_react = __toESM(require_react(), 1);

// node_modules/.pnpm/unhead@2.0.17/node_modules/unhead/dist/shared/unhead.BPM0-cfG.mjs
...
// node_modules/.pnpm/unhead@2.0.17/node_modules/unhead/dist/shared/unhead.B578PsDV.mjs
...
function withSideEffects(input, options, fn) {
  ...
  const entryRef = (0, import_react.useRef)(null);
  if (!entryRef.current) {
    entryRef.current = fn(unhead, input, options);
  }
  const entry = entryRef.current;
  (0, import_react.useEffect)(() => {
    entry == null ? void 0 : entry.patch(input);
  }, [input, entry]);
  (0, import_react.useEffect)(() => {
    return () => {
