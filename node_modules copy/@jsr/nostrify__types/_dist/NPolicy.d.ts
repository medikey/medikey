 ...
 */ export interface NPolicy {
  /** Invoke the policy. If `ok` is set to false, the application should not store or display the message. */ call(event: NostrEvent, signal?: AbortSignal): Promise<NostrRelayOK>;
  /** If this policy would impact a NIP-11 field, those fields are defined here. */ info?: NostrRelayInfo;
}
//# sourceMappingURL=NPolicy.d.ts.map